...
<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  ...
  <text x="112" y="132" font-family="Arial, sans-serif" font-size="24" font-weight="700" fill="#b84e34">LOCAL SHARPEN + RUNPOD AI 2X</text>
  <text x="112" y="206" font-family="Arial, sans-serif" font-size="68" font-weight="800" fill="#17212b">AI Sharpen Image</text>
  <text x="112" y="258" font-family="Arial, sans-serif" font-size="30" fill="#46535f">Compare local sharpening or a limited model-assisted 2x.</text>
  ...
  <text x="143" y="564" font-family="Arial, sans-serif" font-size="22" font-weight="700" fill="#ffffff">USD 5 AI beta ceiling</text>
</svg>`;
