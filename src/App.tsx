        ...
        <section className="tool-layout" aria-labelledby="home-title">
          ...
          <aside className="controls" aria-label={mode === "local" ? "Sharpening controls" : "AI enhancement controls"}>
            ...
            <dl className="facts">
              ...
              {mode === "ai" && <div><dt>Limit</dt><dd>Two best-effort jobs per network and server instance each day, one GPU worker, USD 5 monthly usage target within a one-time USD 10 prepaid ceiling.</dd></div>}
            </dl>
          </aside>
        </section>
